...
public class Main {
  ...
  private static void actionUsrArticleList(List<Article> articles) {
    if (articles.isEmpty()) {
  ...
  private static void actionUsrArticleDelete(String cmd, List<Article> articles) {
  ...
  private static void actionUsrArticleModify(String cmd, Scanner sc, List<Article> articles) {
    String[] cmdBits = cmd.split("/");
  ...
  private static void actionUsrArticleDetail(String cmd, List<Article> articles) {
    String[] cmdBits = cmd.split("/");
